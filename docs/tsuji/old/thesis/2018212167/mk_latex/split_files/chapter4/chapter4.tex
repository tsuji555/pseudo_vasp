...
\KeywordTok{def} \NormalTok{func(ax)}
  ...
  \DataTypeTok{$model}\NormalTok{.total_energy}\DecValTok{+150}\NormalTok{.}\DecValTok{45633275921924}
\KeywordTok{end}
...
\begin{Highlighting}[]
  ...
  \NormalTok{line = gets}
  \NormalTok{x,y=line.chomp.split(}\StringTok{','}\NormalTok{)}
  \DataTypeTok{$model}\NormalTok{.set_cell_size(x.to_f/}\FloatTok{100.0}\DecValTok{+1}\NormalTok{.}\DecValTok{0}\NormalTok{,y.to_f/}\FloatTok{100.0}\DecValTok{+1}\NormalTok{.}\DecValTok{0}\NormalTok{)}
  \NormalTok{z = }\DataTypeTok{$model}\NormalTok{.total_energy}\DecValTok{+150}\NormalTok{.}\DecValTok{45633275921924}
\end{Highlighting}
\end{Shaded}
