...
\includegraphics{./figs/POSCAR_0_3315_46_Al.png}
...
\includegraphics{./figs/thesis/thesis_004.jpeg}
...
\begin{figure}
\centering
\includegraphics{./figs/Al_3315_surface.png}
\caption{}
\end{figure}
...
\includegraphics{./figs/thesis_006.jpeg}
初期値の取り方を間違うと最大6になるが，
...
\begin{figure}
\centering
\includegraphics{./figs/thesis/thesis_007.jpeg}
...
\begin{figure}
\centering
\includegraphics{./figs/thesis/thesis_008.jpeg}
...
\begin{figure}
\centering
\includegraphics{./figs/thesis/thesis_009.jpeg}
...
\begin{figure}
\centering
\includegraphics{./figs/thesis/thesis_010.jpeg}
...
\includegraphics{./auto_delete/auto_delete_002.jpeg}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{参考資料}
        \PY{n}{Trace} \PY{n}{only} \PY{n}{means} \PY{n}{that} \PY{n}{only} \PY{n}{the} \PY{n}{total} \PY{n}{pressure}\PY{p}{,} \PY{n}{i}\PY{o}{.}\PY{n}{e}\PY{o}{.} \PY{n}{the} \PY{n}{line} \PY{n}{http}\PY{p}{:}\PY{o}{/}\PY{o}{/}\PY{n}{cms}\PY{o}{.}\PY{n}{mpi}\PY{o}{.}\PY{n}{univie}\PY{o}{.}\PY{n}{ac}\PY{o}{.}\PY{n}{at}\PY{o}{/}\PY{n}{vasp}\PY{o}{/}\PY{n}{guide}\PY{o}{/}\PY{n}{node112}\PY{o}{.}\PY{n}{html}
        \PY{err}{「}\PY{n}{原子削除操作を加えた対称傾角粒界のエネルギー計算}\PY{err}{」}　\PY{n}{岩佐恭佑}　\PY{n}{関西学院大学理工学部卒業論文}　\PY{l+m+mi}{2016}\PY{n}{年3月}　\PY{n}{p}\PY{p}{,}\PY{l+m+mi}{18}
        \PY{err}{”}\PY{n}{Numerical} \PY{n}{Recipes} \PY{o+ow}{in} \PY{n}{C}\PY{err}{”}\PY{p}{,} \PY{n}{by} \PY{n}{W}\PY{o}{.}\PY{n}{H}\PY{o}{.}\PY{n}{Press} \PY{n}{他}\PY{p}{,}\PY{p}{(}\PY{n}{技術評論社}\PY{p}{,} \PY{l+m+mi}{1993}\PY{p}{)}\PY{p}{,} \PY{n}{pp}\PY{o}{.}\PY{l+m+mi}{285}\PY{o}{\PYZhy{}}\PY{l+m+mi}{289}
         \PY{n}{http}\PY{p}{:}\PY{o}{/}\PY{o}{/}\PY{n}{cms}\PY{o}{.}\PY{n}{mpi}\PY{o}{.}\PY{n}{univie}\PY{o}{.}\PY{n}{ac}\PY{o}{.}\PY{n}{at}\PY{o}{/}\PY{n}{vasp}\PY{o}{/}\PY{n}{guide}\PY{o}{/}\PY{n}{node59}\PY{o}{.}\PY{n}{html}
\end{Verbatim}
